...
WORKDIR /src
COPY ["VanLaw.Dev.TeslaLambda.Function.csproj", "VanLaw.Dev.TeslaLambda.Function/"]
...
Execute unit tests
```
cd "VanLaw.Dev.TeslaLambda.Function/test/VanLaw.Dev.TeslaLambda.Function.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "VanLaw.Dev.TeslaLambda.Function/src/VanLaw.Dev.TeslaLambda.Function"
